...
/* app.get("/books", function (req, res) {
  Book.find({}).then(function (boo) {
    res.send(boo);
  });
}); */
app.get("/books", function (req, res) {
  Book.find({ pages: { $gt: 200, $lt: 500 } }).then(function (boo) {
    res.send(boo);
  });
});
//2. Find books whose rating is less than 5, and sort by the author's name
app.get("/books/rating", function (req, res) {
...
app.get("/books/fiction", function (req, res) {
...
app.get("/people/", function (req, res) {
  Person.find({}).then(function (boo) {
    res.send(boo);
  });
});
//1. Find all the people who are tall (>180) AND rich (>30000)
app.get("/people/tall-rich", function (req, res) {
...
app.get("/people/tall-or-rich", function (req, res) {
  Person.find({
...
app.get("/people/grey-skinny", function (req, res) {
  Person.find({
...
app.get("/people/grey-kid", function (req, res) {
  Person.find({ "kids.hair": "grey" }).then(function (boo) {
    res.send(boo);
  });
});
//5. Find all the people who have at least one overweight kid, and are overweight themselves (>100)
app.get("/people/overweight", function (req, res) {
  Person.find({
